INSERT INTO configuration_properties (deletable, ro, name, creation_date, modification_date, data_type, data, scope, data_type_def, label, mini, maxi, default_value) VALUES
