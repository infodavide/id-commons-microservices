...
cd $SERVICE_HOME
java -Dgateway_service.host="$SERVICE_HOST" \
    -Dgateway_service.port=$SERVICE_PORT \
    -Dgateway_service.profile=$SERVICE_PROFILE \
    -Dgateway_service.user=$SERVICE_USER \
    -Dgateway_service.password="$SERVICE_PASSWORD" \
